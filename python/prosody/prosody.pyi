...
class _NativePublishedMap(Generic[V]):
    ...
    def scan(self, key: str, direction: str) -> NativeJsonMapScan: ...
    def keys(self, key: str, direction: str) -> NativeMapKeyScan: ...
...
class _NativePublishedDeque(Generic[T]):
    ...
    def scan(self, key: str, direction: str) -> NativeJsonDequeScan: ...
